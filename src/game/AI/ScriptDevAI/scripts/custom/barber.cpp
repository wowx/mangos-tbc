...
bool GossipSelect_barber(Player *player, Creature *_Creature, uint32 sender, uint32 action)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 3:
        ...
        player->ADD_GOSSIP_ITEM(0, "I want this.", GOSSIP_SENDER_SUBOPTION, GOSSIP_ACTION_INFO_DEF + 9);
    ...
    case GOSSIP_ACTION_INFO_DEF + 8:
       ...
       // OK zaplat
        case GOSSIP_ACTION_INFO_DEF+9:
            ...
            player->ADD_GOSSIP_ITEM(0, "No thanks... exit", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 8);
